        ...
        if "wake up" in query :
            ...
            while True:
                ...
                #Jarvice  : the triology 2.0#############
                    ...
                    upload_net = wifi.upload()/1048576          #1 mg = 1024*1024 bytes
                    ...
                    if (a==1):
                        ...
                        os.startfile("F:\\vs\\Jarvis\\FocusMode.py")
                        exit()
                ...
                ###########################################
                    ...
                    b = random.choice(a)
                    if b==1:
                        webbrowser.open("https://www.youtube.com/watch?v=eZE6lmQMviE")
                    elif b==2:
                        webbrowser.open("https://www.youtube.com/watch?v=eZE6lmQMviE")
                    elif b==3:
                        webbrowser.open("https://www.youtube.com/watch?v=eZE6lmQMviE")
                    ...
                    from Whatsapp import sendMesage
                    sendMesage(query)
                    ...
                    rememberMessage = query.replace("jarvice","")
                    ...
                    shutdown = input("Do yoy wish to shutdown your computer? (yes/no)")
                    if shutdown == "yes":
